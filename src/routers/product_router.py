...
from src.utils.auth import get_current_user  # Ensure this is an async function if it makes DB calls
...
async def create_product(
    ...
    current_user: User = Depends(get_current_user),  # Ensure this is an async function
):
